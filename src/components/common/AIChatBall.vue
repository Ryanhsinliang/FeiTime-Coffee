    ...
    <transition name="fade">
      ...
      >
        <div class="bg-[#A2AF9B] text-white px-4 py-2 flex flex-col">
          ...
          >
            <div
              class="w-12 h-1 bg-white/30 rounded-full group-hover:bg-white/60 transition-colors"
            ></div>
          </div>
          ...
          <div class="flex justify-between items-center">
            ...
            <button @click="showChat = false" class="text-white font-bold hover:opacity-80">
              ✕
            </button>
          </div>
        </div>
...
<script setup lang="ts">
  ...
  const messages = ref<Message[]>([
    {
      user: 'ai',
      text: '嗨！我是你的咖啡小精靈 ☕<br>有什麼咖啡問題想問我嗎~咕嚕咕嚕？',
    },
  ]);
