        ...
        options: [
          {
            ...
            label: '越酸越喜歡，果汁感明亮',
            helper: '',
            score: { acidity: 15, sweetness: 5, body: 0, aftertaste: 0, clarity: 5 },
          },
          {
            option: 'b',
            label: '可以接受微酸，但不刺激',
            helper: '',
            score: { acidity: 10, sweetness: 5, body: 3, aftertaste: 0, clarity: 5 },
          },
          {
            option: 'c',
            label: '偏好溫和滑順',
            helper: '',
            score: { acidity: 5, sweetness: 0, body: 5, aftertaste: 5, clarity: 5 },
          },
          {
            option: 'd',
            label: '完全不喜歡酸，只想要濃郁感',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 10, aftertaste: 5, clarity: 5 },
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            label: '水果塔、莓果甜點',
            helper: '',
            score: { acidity: 5, sweetness: 15, body: 0, aftertaste: 0, clarity: 5 },
          },
          {
            option: 'b',
            label: '焦糖布丁',
            helper: '',
            score: { acidity: 0, sweetness: 12, body: 5, aftertaste: 3, clarity: 5 },
          },
          {
            option: 'c',
            label: '巧克力蛋糕',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 10, aftertaste: 8, clarity: 0 },
          },
          {
            option: 'd',
            label: '基本不吃甜',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 5, aftertaste: 0, clarity: 10 },
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            label: '清爽，像茶一樣透明',
            helper: '',
            score: { acidity: 5, sweetness: 0, body: 0, aftertaste: 0, clarity: 15 },
          },
          {
            option: 'b',
            label: '適中，有些存在感',
            helper: '',
            score: { acidity: 0, sweetness: 5, body: 5, aftertaste: 5, clarity: 5 },
          },
          {
            option: 'c',
            label: '濃郁、有重量感',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 10, aftertaste: 5, clarity: 0 },
          },
          {
            option: 'd',
            label: '非常濃稠、像巧克力',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 15, aftertaste: 10, clarity: 0 },
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            label: '早上醒腦時喝',
            helper: '',
            score: { acidity: 5, sweetness: 0, body: 0, aftertaste: 0, clarity: 10 },
          },
          {
            option: 'b',
            label: '下午放鬆時喝',
            helper: '',
            score: { acidity: 0, sweetness: 10, body: 3, aftertaste: 2, clarity: 5 },
          },
          {
            option: 'c',
            label: '晚上工作或閱讀',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 5, aftertaste: 10, clarity: 0 },
          },
          {
            option: 'd',
            label: '沒固定時段，想到就喝',
            helper: '',
            score: { acidity: 3, sweetness: 3, body: 5, aftertaste: 10, clarity: 5 },
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            label: '短、俐落',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 0, aftertaste: 0, clarity: 15 },
          },
          {
            option: 'b',
            label: '適中即可',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 0, aftertaste: 5, clarity: 10 },
          },
          {
            option: 'c',
            label: '中長尾韻',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 5, aftertaste: 10, clarity: 5 },
          },
          {
            option: 'd',
            label: '越長越濃',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 5, aftertaste: 15, clarity: 0 },
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            label: '花香、果香',
            helper: '',
            score: { acidity: 10, sweetness: 0, body: 0, aftertaste: 0, clarity: 10 },
          },
          {
            option: 'b',
            label: '堅果、焦糖',
            helper: '',
            score: { acidity: 0, sweetness: 10, body: 5, aftertaste: 0, clarity: 5 },
          },
          {
            option: 'c',
            label: '巧克力、可可',
          ...
          },
          {
            ...
            label: '木質、烘焙香',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 8, aftertaste: 8, clarity: 0 },
          },
        ],
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            label: '義式機（濃縮）',
            helper: '',
            score: { acidity: 0, sweetness: 0, body: 12, aftertaste: 8, clarity: 0 },
          },
          {
            option: 'c',
            label: '法壓',
            helper: '',
            score: { acidity: 0, sweetness: 5, body: 10, aftertaste: 0, clarity: 5 },
          },
          {
            option: 'd',
            label: '冷萃',
            helper: '',
            score: { acidity: 0, sweetness: 8, body: 0, aftertaste: 0, clarity: 10 },
          },
        ],
      },
      {
        ...
        options: [
          {
            ...
            label: '清新、明亮、有活力',
            helper: '',
            score: { acidity: 12, sweetness: 0, body: 0, aftertaste: 0, clarity: 10 },
          },
          {
            option: 'b',
            label: '甜美、舒服、療癒',
            helper: '',
            score: { acidity: 0, sweetness: 12, body: 5, aftertaste: 0, clarity: 5 },
          },
          {
            option: 'c',
            label: '濃郁、紮實、有存在感',
