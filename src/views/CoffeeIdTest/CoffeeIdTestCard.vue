...
<script setup lang="ts">
  ...
  function recalculateScores() {
    ...
    quizData.answers.forEach((ans) => {
      if (!ans) return;
      quizData.scores.acidity += ans.acidity;
      quizData.scores.sweetness += ans.sweetness;
      quizData.scores.body += ans.body;
      quizData.scores.aftertaste += ans.aftertaste;
      quizData.scores.clarity += ans.clarity;
    });
  }
