                ...
                >
                  ...
                  <div class="mb-4 grid grid-cols-1 gap-8">
                    ...
                    <div class="flex flex-col gap-2.5 pt-2">
                      <div
                        v-for="item in flavorEntries"
                        :key="item.key"
                        class="flex items-center"
                      >
                        <span class="w-16 text-[13px] text-[#273c35]">{{ labelMap[item.key] }}</span>

                        <div class="mx-2 flex-1 h-2 overflow-hidden rounded-full bg-[rgba(240,232,220,0.9)]">
                          <div
                        ...
                        <span class="w-9 text-right text-[12px] text-[#3c3a37]">
