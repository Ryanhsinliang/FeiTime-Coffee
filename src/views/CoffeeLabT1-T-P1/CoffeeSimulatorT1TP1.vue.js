...
const flavorEntries = computed(() => flavorKeys.map((key) => ({ key, value: finalProfile.value[key] })));
const labelMap = {
    Sweetness: '甜度',
    Acidity: '酸質',
    Clarity: '清晰度',
...
__VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "grid gap-6 xl:grid-cols-[minmax(0,1.4fr)_minmax(0,1.1fr)]" },
});
__VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
...
__VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "mb-4 grid grid-cols-1 gap-8" },
});
/** @type {[typeof FlavorRadar, ]} */ ;
// @ts-ignore
const __VLS_0 = __VLS_asFunctionalComponent(FlavorRadar, new FlavorRadar({
    scores: (__VLS_ctx.finalProfile),
    labelMap: (__VLS_ctx.labelMap),
}));
...
// @ts-ignore
[finalProfile, labelMap,];
__VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "flex flex-col gap-2.5 pt-2" },
});
for (const [item] of __VLS_getVForSourceType((__VLS_ctx.flavorEntries))) {
    // @ts-ignore
    [flavorEntries,];
    __VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        key: (item.key),
    ...
    __VLS_asFunctionalElement(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "w-16 text-[13px] text-[#273c35]" },
    });
    (__VLS_ctx.labelMap[item.key]);
    // @ts-ignore
    [labelMap,];
    __VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "mx-2 flex-1 h-2 overflow-hidden rounded-full bg-[rgba(240,232,220,0.9)]" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "h-full rounded-full transition-[width] duration-300 ease-out" },
        ...{ style: ({
                width: (item.value / 5) * 100 + '%',
                background: __VLS_ctx.getGradient(item.value),
            }) },
    });
    // @ts-ignore
    [getGradient,];
    __VLS_asFunctionalElement(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: "w-9 text-right text-[12px] text-[#3c3a37]" },
    });
...
/** @type {[typeof GeminiTestButton, ]} */ ;
// @ts-ignore
const __VLS_5 = __VLS_asFunctionalComponent(GeminiTestButton, new GeminiTestButton({}));
...
/** @type {__VLS_StyleScopedClasses['gap-6']} */ ;
/** @type {__VLS_StyleScopedClasses['xl:grid-cols-[minmax(0,1.4fr)_minmax(0,1.1fr)]']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-2xl']} */ ;
/** @type {__VLS_StyleScopedClasses['border']} */ ;
